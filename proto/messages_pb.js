...
proto.messages.Contract.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes)
  const msg = new proto.messages.Contract()
 ...
 * @return {number}
 */
proto.messages.ARAid.prototype.getId = function () {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0))
}

/** @param {number} value */
proto.messages.ARAid.prototype.setId = function (value) {
  jspb.Message.setField(this, 1, value)
}

/**
 * optional int64 signature = 2;
 * @return {number}
 */
proto.messages.ARAid.prototype.getSignature = function () {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0))
}

/** @param {number} value */
proto.messages.ARAid.prototype.setSignature = function (value) {
  jspb.Message.setField(this, 2, value)
}
